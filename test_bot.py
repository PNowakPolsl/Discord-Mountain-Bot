...
class TestBotCommands(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_widok_valid_single_camera(self):
        ...
        self.ctx_mock.send.assert_any_call("Aby dodać ten widok do ulubionych, użyj komendy: !dodaj_ulubione w odpowiedzi na tę wiadomość.")

    async def test_ulubione_tatry_empty(self):
        await bot.ulubione_tatry(self.ctx_mock)
        self.ctx_mock.send.assert_called_once_with("📭 Nie masz żadnych ulubionych widoków.")
